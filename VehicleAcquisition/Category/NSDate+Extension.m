...
- (NSDate *)dateWithFormatter:(NSString *)formatter  withStr:(NSString *)str {
...
- (NSString *)conversionTimestamp {
    ...
    NSInteger timeSp = [[NSNumber numberWithDouble:[self timeIntervalSince1970]] integerValue];
    return [NSString stringWithFormat:@"%lu", timeSp];
}
