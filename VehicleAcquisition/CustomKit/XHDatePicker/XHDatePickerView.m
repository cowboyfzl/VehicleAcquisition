...
- (void)setDoneButtonColor:(UIColor *)doneButtonColor {
    [_doneBtn setTitleColor:doneButtonColor forState:UIControlStateNormal];
}

- (void)setButtTitle:(NSString *)buttTitle {
    [_doneBtn setTitle:buttTitle forState:UIControlStateNormal];
}
...
-(void)addLabelWithName:(NSArray *)nameArr {
    ...
    for (int i=0; i<nameArr.count; i++) {
        ...
        UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(labelX + 2, self.showYearView.frame.size.height/2-7.5, 15, 15)];
